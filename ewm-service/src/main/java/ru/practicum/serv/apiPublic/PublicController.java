package ru.practicum.serv.apiPublic;
...
public class PublicController {
    ...
    public ResponseEntity<Collection<CategoryDto>> getAllCategories(@PositiveOrZero @RequestParam(defaultValue = "0") Integer from,
                                                                    @Min(1) @RequestParam(defaultValue = "10") Integer size) {
    ...
    @GetMapping("events")
    public ResponseEntity<Collection<EventShortDto>> getAllEvents(@RequestParam(required = false) String text,
